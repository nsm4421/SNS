...
class RemoteAuthDataSourceImpl
  ...
  Future<AuthUserModel> getAuthUser() async =>
      await guardApi<AuthUserModel>(() async {
  ...
  Future<(String accessToken, String refreshToken)> signIn({
    ...
    required String password,
      ...
      await guardApi<(String accessToken, String refreshToken)>(() async {
        {
