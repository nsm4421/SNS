...
micro package for local storage

## Installation 💻

**❗ In order to start using Local Storage you must have the [Dart SDK][dart_install_link] installed on your machine.**

Install via `dart pub add`:

```sh
dart pub add local_storage
```
